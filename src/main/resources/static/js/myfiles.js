...
function openDocumentModal(documentId) {
    ...
    fetch(`/documents/details/${documentId}`)
        ...
        .then(data => {
            ...
            // Populate tags - FIXED to use tagNames array from DTO
...
/**
 * Toggle edit mode - just show the already-populated fields
 */
function toggleEditMode() {
    ...
    // Show custom group container if currently set to custom group (ID = 5)
...
/**
 * Toggle custom group visibility when viewer group changes
 */
