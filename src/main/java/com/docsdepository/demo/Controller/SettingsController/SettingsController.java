...
import com.docsdepository.demo.Services.PasswordService.PasswordResult;
...
public class SettingsController {
    ...
    public Map<String, Object> changePassword(
        ...
        PasswordResult result = passwordService.changePassword(user, currentPassword, newPassword, confirmPassword);
